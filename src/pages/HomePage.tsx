...
{/* cover content  */}
 ...
 <div className=' bg-black text-white py-4 px-5 font-semibold hover:transition-all hover:duration-150 hover:bg-gray-700 flex w-56 cursor-pointer items-center justify-center rounded-md'>
...
<h1>Living Room</h1>
  ...
  <div className=' bg-transparent border-white border w-32 items-center justify-center py-2 flex hover:bg-white hover:text-black rounded-sm'>
<Link to={'/'}>Shop Now</Link>
</div>
